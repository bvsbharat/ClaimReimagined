...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 overflow-x-hidden font-['Outfit'] selection:bg-[#ff0083] selection:text-white">
      ...
      {/* Hero Section */}
      <div className="relative pt-16 pb-40 flex flex-col items-center text-center px-4 max-w-4xl mx-auto z-10">
      ...
      {/* Hero Visual - Image Backdrop */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1.5 }}
        className="relative w-full h-[60vh] md:h-[80vh] mt-[-100px] pointer-events-none overflow-hidden"
      >
          ...
          {/* Floating UI Cards */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4 w-full max-w-5xl px-4">
      ...
      {/* Features Section */}
      <div id="features" className="max-w-7xl mx-auto px-8 py-24 md:py-32">
         <motion.div 
      ...
      {/* Bottom CTA */}
      <div className="bg-[#ff0083] text-white py-32 px-8 text-center relative overflow-hidden">
          {/* Decorative circles */}
      ...
      {/* Footer */}
      <footer className="bg-white py-16 text-center text-slate-400 text-sm font-light border-t border-slate-50">
